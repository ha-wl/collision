...
def main(args: Args):
    ...
    def collate_fn(dataset: list) -> BatchEncoding:
        ...
        return ids, patterns, inputs, labels, weightspeeds, distributions
    ...
    def evaluate(dataloader: DataLoader):
        model.eval()
        gold_labels, pred_labels, id_list, pattern_list, weightspeed_list, distribution_list = [], [], [], [], [], []
        output_list = []
        prediction_list = []
        ...
        for batch in tqdm(dataloader, total=len(dataloader), dynamic_ncols=True, leave=False):
            ...
            ids, patterns, input_ids, outputs, weightspeeds, distributions = batch
        ...
        return output_list, prediction_list, weightspeed_list, distribution_list
    ...
    for epoch in trange(args.epochs, dynamic_ncols=True):
        ...
        for batch in tqdm(
            ...
            ids, pattern, input_ids, outputs,weightspeeds, distributions = batch
